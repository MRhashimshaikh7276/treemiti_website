            ...
            <div className={Styles.mainFeedback}>
                <div className={Styles.rowFeed}>
                    ...
                    <div className={Styles.leftFeed}>
                        ...
                        <div className={Styles.Feedtext1}><h2>Employers Feedback</h2></div>
                        ...
                        <div className={Styles.Feedcard}>
                            ...
                            <div className={Styles.Feedtext2}>
                                <p>We always find talented professionals from <br />
                                    Treemiti Informatics. We consider Treemiti as our <br /> training partner for latest technologies in our field </p>
                            </div>
